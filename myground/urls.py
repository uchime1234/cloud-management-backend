...
urlpatterns = [
    ...
    # ============================================================
    # ⭐ NEW: SERVICE & RESOURCE BREAKDOWN (REPLACES OLD FEATURES)
    # ============================================================
    path(
        'aws/accounts/<int:account_db_id>/service-resource-breakdown/',
        views.get_service_resource_breakdown,
        name='service_resource_breakdown'
    ),
    path(
        'aws/accounts/<int:account_db_id>/service-resource-breakdown/clear/',
        views.clear_service_resource_breakdown,
        name='clear_service_resource_breakdown'
    ),
...
path( 'aws/accounts/<int:account_db_id>/resources/<path:resource_id>/action/',views.resource_action, name='resource_action'),
    ...
    # ============================================================
    # COST SPIKES & DEPLOYMENT CORRELATION
    # ============================================================
